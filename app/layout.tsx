...
export const metadata: Metadata = {
  ...
  keywords:
    "woodworking, custom furniture, kitchen cabinets, commercial woodwork, handcrafted furniture",
  authors: [{ name: "Palace Woodwork" }],
  openGraph: {
    title: "Palace Woodwork - Premium Custom Woodworking Services",
    description:
      "Professional woodworking services with exceptional craftsmanship",
    type: "website",
    locale: "en_US",
  },
  generator: "v0.dev",
